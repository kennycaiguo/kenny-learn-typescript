...
let id:string|number=1 //id可以是字符串或者数字，所以可以赋值为1
id="2" //因为是联合类型，可以修改为字符串

function reconId(id:string|number|{first:number,second:String}){
    if(typeof id ==='string')
    {
...
function showWelcome(name:string[]|string){
...
function getFirst3(num:number[]|string){
